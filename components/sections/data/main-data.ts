...
Ven con tu mejor disfraz (opcional) y prepárate para pasarla de miedo 😈`,
    ...
    date: {
      full: "Viernes 31 de Octubre 2025",
      isoDate: "2025-10-31T19:30:00",
      day: "Viernes",
      dayNumber: "31",
      month: "Octubre",
      year: "2025",
    ...
    party: {
      time: "19:30 hrs.",
      venue: "",
      address: "Soberia 2688, MonteCarlo Residencial, Montecarlo 3ra Etapa, 21255 Mexicali, B.C.",
      type: "Recepción",
      ubiLink: "https://maps.app.goo.gl/NxhforNZUPaz7Etb8",
    },
